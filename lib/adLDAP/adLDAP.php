...
class adLDAP {
    ...
    */
    public function adldap_schema($attributes) {
        ...
        //Added by Públio Cavalcante
        if (isset($attributes["physicalDeliveryOfficeName"])){ $mod["physicalDeliveryOfficeName"][0]=$attributes["physicalDeliveryOfficeName"]; }
        ...
        if (isset($attributes["department"])){ $mod["department"][0]=$attributes["department"]; }
        if (isset($attributes["departmentNumber"])){ $mod["departmentNumber"][0]=$attributes["departmentNumber"]; }
        if (isset($attributes["roomNumber"])){ $mod["roomNumber"][0]=$attributes["roomNumber"]; }
